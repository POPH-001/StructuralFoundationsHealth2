...
ggplot(bens, aes(benefit, pct, fill = earners)) +
  ...
  scale_fill_manual(values = c("Lowest-paid 10%" = "#C62828",
                               "Highest-paid 10%" = "#2E7D32")) +
  ...
  theme(plot.title = element_text(face = "bold", colour = "#008080", size = 15),
        legend.position = "top",
...
ggplot(unins, aes(st, pct, fill = st)) +
  ...
  scale_fill_manual(values = c("Expansion states" = "#2E7D32",
                               "Non-expansion states" = "#C62828")) +
  ...
  theme(plot.title = element_text(face = "bold", colour = "#008080", size = 16),
